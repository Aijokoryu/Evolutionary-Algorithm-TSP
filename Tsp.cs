...
namespace Evolutionary_Algorithm_TSP {
    ...
    internal class Tsp {
        ...
        public void GenerateSolution() {
            do {
                ...
                for (int i = 0; i < generations; i++) {
                    //parent selection
                    //since we always have only 2 parents, we dont need to look select new parents
                    Population newPopulation = Variation();
                    Evaluation(newPopulation, ref improvement);
                }
                Console.WriteLine("Your settings:\nXMLData" + xmlData + " generations:"
                    + generations + " mutationprobability:" + mutationProbability
                    + " Start Populations (without the 2 default):" + randomStartPopulationsAmount + " crossovers:" + crossoverAmount+"\n");
        ...
        private void InitialPopulation() {
            ...
            Console.WriteLine("The start generations generated " + improvement + " many improvements\n");
        }
        /// <summary>
